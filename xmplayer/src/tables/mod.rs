...
pub const LINEAR_PERIODS: [u16; 1936] = {
    let mut periods = [0u16; 1936];
    let mut i = 0;
    while i < 1936 {
        periods[i] = (7744 - (i as i32 * 4)) as u16;
        i += 1;
    }
    periods
};
...
mod tests {
    ...
    const BIT_EXACT_LINEAR_PERIODS: [u16; 1936] = [
    ...
    #[test]
    fn verify_linear_periods() {
        for i in 0..1936 {
            assert_eq!(LINEAR_PERIODS[i], BIT_EXACT_LINEAR_PERIODS[i], "Mismatch at index {}", i);
        }
    }
}
